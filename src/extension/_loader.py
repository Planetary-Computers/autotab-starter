...
def update():
    ...
    response = requests.get('https://github.com/Planetary-Computers/autotab-extension/raw/main/autotab.crx', stream=True)
...
def should_update():
    if not os.path.exists('src/extension/autotab'):
        return True
    # Fetch the XML file
    response = requests.get('https://raw.githubusercontent.com/Planetary-Computers/autotab-extension/main/update.xml')
